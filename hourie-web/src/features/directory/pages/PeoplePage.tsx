...
import { createEmployee, deleteEmployee, getEmployee, getEmployees, updateEmployee } from '../api'
...
export function PeoplePage({ canAdd, canManageManagerAccounts = false, catalogs }: PeoplePageProps) {
