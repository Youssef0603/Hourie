...
export function EquipmentImages({ equipment, canManage, onChanged, title = fr.images.title }: EquipmentImagesProps) {
  ...
  return <section className="equipment-images-section">
    <div className="section-heading-row"><div><h3>{title}</h3><p>{fr.images.count(equipment.images.length)}</p></div></div>
